...
# Main function of the MBL learning method. The learning process is stopped at a specific episode and then the learned MRF is used
function main()
    
    # Results directory
    test = "Test/MBL_introduction/"
    mkpath(test)
    ...
    # Matrices required to update and to use the MRF
	...
	# MRF update based on maximum likelihood particle in the belief
